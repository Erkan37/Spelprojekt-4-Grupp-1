...
AudioLibrary::AudioLibrary()
{
	...
	myAudioList.insert_or_assign(AudioList::SpikeHit,        new AudioClip("Sounds/Effects/SpikeHit.wav",         false, 0.2f, 0, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::PlayerRespawn,   new AudioClip("Sounds/Effects/Respawn.wav",          false, 0.07f,0, 1,    AudioLayer::SoundEffect));
	...
	myAudioList.insert_or_assign(AudioList::WalkGravelRight, new AudioClip("Sounds/Effects/WalkGravelRight.wav",  false, 0.4f, 0, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkGravelLeft,  new AudioClip("Sounds/Effects/WalkGravelLeft.wav",   false, 0.4f, 0, 1,    AudioLayer::SoundEffect));
	...
	myAudioList.insert_or_assign(AudioList::WalkBrickRight,  new AudioClip("Sounds/Effects/WalkBrickRight.wav",   false, 0.4f, 0, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkBrickLeft,   new AudioClip("Sounds/Effects/WalkBrickLeft.wav",    false, 0.4f, 0, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkWoodLeft,    new AudioClip("Sounds/Effects/WalkWoodLeft.wav",     false, 0.4f, 0, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkWoodRight,   new AudioClip("Sounds/Effects/WalkWoodRight.wav",    false, 0.4f, 0, 1,    AudioLayer::SoundEffect));
	...
	myAudioList.insert_or_assign(AudioList::PlayerDeath,     new AudioClip("Sounds/Effects/death.wav",            false, 0.3f, 0, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::ButtonPress,     new AudioClip("Sounds/Effects/ButtonPress.wav",      false, 0.4f, 0, 1,    AudioLayer::SoundEffect));

	myAudioList.insert_or_assign(AudioList::MenuAmbience,    new AudioClip("Sounds/Effects/MenuAmbience.wav",     true, 0.1f, 0, 1,    AudioLayer::SoundEffect));
