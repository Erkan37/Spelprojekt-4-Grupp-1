...
AudioLibrary::AudioLibrary()
{
	...
	myAudioList.insert_or_assign(AudioList::WalkGravelRight, new AudioClip("Sounds/Effects/WalkGravelRight.wav",  false, 0.4f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkGravelLeft,  new AudioClip("Sounds/Effects/WalkGravelLeft.wav",   false, 0.4f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkGrassRight,  new AudioClip("Sounds/Effects/WalkGrassRight.wav",   false, 0.4f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkGrassLeft,   new AudioClip("Sounds/Effects/WalkGrassLeft.wav",    false, 0.4f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkBrickRight,  new AudioClip("Sounds/Effects/WalkBrickRight.wav",   false, 0.4f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkBrickLeft,   new AudioClip("Sounds/Effects/WalkBrickLeft.wav",    false, 0.4f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkWoodLeft,    new AudioClip("Sounds/Effects/WalkWoodLeft.wav",     false, 0.4f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkWoodRight,   new AudioClip("Sounds/Effects/WalkWoodRight.wav",    false, 0.4f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkStoneLeft,   new AudioClip("Sounds/Effects/WalkStoneLeft.wav",    false, 0.4f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkStoneRight,  new AudioClip("Sounds/Effects/WalkStoneRight.wav",   false, 0.4f, 1,    AudioLayer::SoundEffect));

	myAudioList.insert_or_assign(AudioList::LandOnGrassEasy, new AudioClip("Sounds/Effects/LandGrassEasy.wav",    false, 0.4f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::LandOnGrassHeavy,new AudioClip("Sounds/Effects/LandGrassHeavy.wav",   false, 0.2f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::LandOnStoneHeavy,new AudioClip("Sounds/Effects/LandStoneHeavy.wav",   false, 0.4f, 1,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::LandOnStoneLight,new AudioClip("Sounds/Effects/LandStoneLight.wav",   false, 0.2f, 1,    AudioLayer::SoundEffect));
